 ...
 */
$config['site_title']                 = "Dorohty";       // Site Title, example.com
$config['admin_email']                = "admin@dorothy"; // Admin Email, admin@example.com
$config['default_group']              = 'Etudiant';           // Default group, use name
